...
<head>
    ...
    <title>HyperRack - Laporan Petugas</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <p class="role-title">Petugas</p>
        <ul class="side-nav">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li><a href="{{ route('admin.produk') }}">Kelola Produk</a></li>
            <li><a href="{{ route('admin.kelolaorder') }}">Kelola Order</a></li>
            <li><a href="{{ route('admin.riwayat') }}">Riwayat Pesanan</a></li>
    ...
    <main class="main-content">
        ...
        <div class="content-body">
            <div class="section-header">
                <h1 class="welcome-title">Laporan Penjualan & Barang</h1>
