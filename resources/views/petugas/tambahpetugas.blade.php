...
<head>
    ...
    <title>Tambah Petugas - HyperRack</title>
    ...
    <main class="main-content">
        ...
        <div class="content-body">
            <div class="header-row">
                ...
                <h2 style="font-size: 24px; font-weight: 700;">Tambah Petugas Baru</h2>
            </div>
            ...
            <div class="form-card">
                <form action="{{ route('admin.petugas.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" placeholder="Masukkan nama petugas" required>
                    </div>
